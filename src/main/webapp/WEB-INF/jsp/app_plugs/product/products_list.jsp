...
<head>
    ...
    <script src="htgl_1/assets/js/jquery.dataTables.min.js"></script>
    <script src="htgl_1/assets/js/jquery.dataTables.bootstrap.js"></script>
...
<div class=" page-content clearfix">
    <div id="products_style">
       ...
       <span class="l_f">
        ...
        <c:if test="${QX.add == 1 }">
            <a title="添加商品" class="btn btn-warning Order_form" onclick="member_edit('添加商品','<%=basePath%>prudoct/prudoctAdd.do','4','','510')" >添加商品1</a>
        </c:if>
		<c:if test="${QX.del == 1 }">
            <a class="btn btn-danger" onclick="makeAll('确定要删除选中的数据吗?');" title="批量删除" ><i class="icon-trash"></i>批量删除</a>
        </c:if>
       </span>
                ...
                <table class="table table-striped table-bordered table-hover" id="sample-table">
                    ...
                    <tr>
                        ...
                        <td class="td-manage">
                            ...
                            <a title="编辑" onclick="member_edit('编辑商品','<%=basePath%>prudoct/prudoctAdd.do','4','','510')" href="javascript:;"  class="btn btn-xs btn-info" ><i class="icon-edit bigger-120"></i></a>
                    ...
                    <tr>
                        ...
                        <td class="td-manage">
                            <a onClick="member_stop(this,'10001')"  href="javascript:;" title="停用"  class="btn btn-xs btn-success"><i class="icon-ok bigger-120"></i></a>
                            <a title="编辑" onclick="member_edit('编辑商品','<%=basePath%>prudoct/prudoctAdd.do','4','','510')"   class="btn btn-xs btn-info" ><i class="icon-edit bigger-120"></i></a>
                            <a title="删除" href="javascript:;"  onclick="member_del(this,'1')" class="btn btn-xs btn-warning" ><i class="icon-trash  bigger-120"></i></a>
                        </td>
                    </tr>
...
<script type="text/javascript">
    ...
    function addproducts(){
        ...
        diag.Drag=true;
        diag.Title ="新增商品";
        diag.URL = '<%=basePath%>prudoct/prudoctAdd.do';
        diag.Width = 450;
        diag.Height = 355;
