...
<head>
    <base href="<%=basePath%>">
    <!--[if lt IE 9]>
    <script type="text/javascript" src="htgl_1/js/html5.js"></script>
    <script type="text/javascript" src="htgl_1/js/respond.min.js"></script>
    <script type="text/javascript" src="htgl_1/js/PIE_IE678.js"></script>
    <![endif]-->
    ...
    <link rel="stylesheet" href="htgl_1/Widget/zTree/css/zTreeStyle/zTreeStyle.css" type="text/css">
    ...
    <link href="htgl_1/Widget/webuploader/0.1.5/webuploader.css" rel="stylesheet" type="text/css" />
...
<script src="htgl_1/js/jquery-1.9.1.min.js"></script>
<script src="htgl_1/assets/js/bootstrap.min.js"></script>
<script src="htgl_1/assets/js/typeahead-bs2.min.js"></script>
<script src="htgl_1/assets/layer/layer.js" type="text/javascript" ></script>
<script src="htgl_1/assets/laydate/laydate.js" type="text/javascript"></script>
<script type="text/javascript" src="htgl_1/Widget/My97DatePicker/WdatePicker.js"></script>
...
<script type="text/javascript" src="htgl_1/Widget/webuploader/0.1.5/webuploader.min.js"></script>
<script type="text/javascript" src="htgl_1/Widget/ueditor/1.4.3/ueditor.config.js"></script>
<script type="text/javascript" src="htgl_1/Widget/ueditor/1.4.3/ueditor.all.min.js"> </script>
<script type="text/javascript" src="htgl_1/Widget/ueditor/1.4.3/lang/zh-cn/zh-cn.js"></script>
